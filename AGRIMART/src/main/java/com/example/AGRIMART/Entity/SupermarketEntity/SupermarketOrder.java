...
public class SupermarketOrder {
    ...
    private SupermarketOrderDto.ProductCategory productCategory;
    ...
    @OneToMany(mappedBy = "supermarketOrder", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
