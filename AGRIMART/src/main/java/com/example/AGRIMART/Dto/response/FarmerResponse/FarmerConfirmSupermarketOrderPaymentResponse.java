...
@Getter
@Setter
public class FarmerConfirmSupermarketOrderPaymentResponse extends Response {
    private FarmerConfirmSupermarketOrder farmerConfirmSupermarketOrderPaymentResponse;
